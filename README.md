...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
	semantic code is the meaningful code on the browswer, it's important for SEO (Search Engine Optimization) and accessability.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

	Inline does not start on a new line, while block starts a new line. Inline only takes up as much data as it needs, while block takes up the maximum space. 
...
5. Explain why git is valuable to a team of developers.
	...
	its a means to share your work and version control.
